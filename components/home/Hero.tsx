          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="space-y-3 text-lg text-slate-400 max-w-2xl leading-relaxed mb-10">
              ...
              <p>
                ...
                que l&apos;impact qu&apos;il peut avoir sur une décision métier opérationnelle. Le fait
                que ce domaine soit en perpétuelle évolution me fascine : les outils s&apos;améliorent,
                et les solutions à construire deviennent de plus en plus ambitieuses.
                Cette nécessité de s&apos;adapter en permanence représente pour moi autant un challenge
                intellectuel qu&apos;une source de motivation constante.
              </p>
              <p>
                Aujourd&apos;hui, je cherche un premier CDI en tant que Data Scientist ou AI Engineer,
                au sein d&apos;un environnement stimulant dans lequel je pourrai continuer à progresser
                et m&apos;attaquer à de nouveaux défis.
              </p>
            </div>
